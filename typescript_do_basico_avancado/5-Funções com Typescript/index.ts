...
// 63 - Tipo Never
function showErrorMessage(msg: string): never { // poderiamos usar void no lugar de never
  throw new Error(msg)
}
...
const skirt = { name: "pink skirt", price: 70 };
const shirt = { name: "white shirt", price: 40 };
